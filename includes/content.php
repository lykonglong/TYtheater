    ...
    <div class="row five-columns row--flex">
        <div class="col-xxl-2 col-lg-3 col-md-4 col-sm-6">
            <a href="video.html" class="video-preview video-preview--sm js-ajax-link">
                ...
                <h5 class="video-preview__descr">Be careful with your thoughts �� they are the beginning of deeds</h5>
            </a>
            ...
            <a href="video.html" class="video-preview video-preview--sm js-ajax-link">
                ...
                <h5 class="video-preview__descr">Only having descended the gulf, you can acquire treasure</h5>
            </a>
        </div>                           <div class="col-xxl-2 col-lg-3 col-md-4 col-sm-6">
            <a href="video.html" class="video-preview video-preview--sm js-ajax-link">
                <div class="video-preview__image">
                ...
                <h5 class="video-preview__descr">To live is the rarest thing in the world. Most people exist, that��s all</h5>
            </a>
        </div>                           <div class="col-xxl-2 col-lg-3 col-md-4 col-sm-6">
            <a href="video.html" class="video-preview video-preview--sm js-ajax-link">
                <div class="video-preview__image">
                ...
                <h5 class="video-preview__descr">Wake at dawn with a winged heart and give thanks for another day of loving</h5>
            </a>
        </div>                           <div class="col-xxl-2 col-lg-3 col-md-4 col-sm-6">
            <a href="video.html" class="video-preview video-preview--sm js-ajax-link">
                <div class="video-preview__image">
                ...
                <h5 class="video-preview__descr">The earth is my body. My head is in the stars</h5>
            </a>
        </div>                        </div>
</div>
</div>
