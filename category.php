...
<div class="col-xxl-10 col-md-9 col-sm-8">
    <div class="row five-columns row--flex">
        ...
        $query = "SELECT * FROM movies WHERE movie_cate_id=$cate_id and status = 1 ORDER BY movie_id DESC";
        ...
        for ($p = 0; $p < count($results->data); $p++):
            ...
            <div class="col-xxl-2 col-lg-3 col-md-4 col-sm-6">
                ...
                <a href="<?php echo BASE_URL; ?>/trailer.php?movie=<?php echo $movie['movie_id']; ?>"
                   class="video-preview video-preview--sm js-ajax-link">
                    <div class="video-preview__image">
                        <span class="lazy-bg-img"
                              data-original="<?php echo BASE_URL; ?>/movie/cover/<?php echo $movie['movie_image']; ?>"></span>
...
<?php
$links = 10;
echo $paginator->cateLinks($links,$cate_id);
