                    ...
                    <table id="example1" class="table table-bordered table-hover">
                        ...
                        while($row = mysqli_fetch_assoc($select_slider)){
                            ...
                            <tr>
                                ...
                                <td align="center" style=""><img src="<?php echo BASE_URL; ?>/images/slider/<?php echo $slider_image;?>" class="img-responsive" alt="<?php echo $slider_image;?>" style="height: 30px;"></td>
